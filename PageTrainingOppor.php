...
<head>
  ...
  <title>Page training opportunity</title>
  ...
  <div class="container" style="margin-bottom:170px;">
    ...
    <div class="row"  style="margin-left:17%;">
      <div class="col-lg-8 mb-4">
        ...
        <form action="PageTrainingOpporDB.php" method="post">

          <div class="control-group form-group">
            <div class="controls">
              <label>Place of opportinity :</label>
              <input type="text" class="form-control" name="PlaceOfOppor">
            </div>
          </div>
          ...
          <div class="control-group form-group">
            <div class="controls">
              ...
              <input type="text" class="form-control" name="OpporType">
            </div>
          </div>

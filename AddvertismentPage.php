...
<head>
  ...
  <title>Addvertisment page</title>
  ...
  <div class="container" style="">
    ...
    <div class="row"  style="margin-left:17%;">
      <div class="col-lg-8 mb-4">
        <form action="AddvertismentPageDB.php" method="post" enctype="multipart/form-data">
          ...
          <div class="control-group form-group">
            <div class="controls">
              <label>Content:</label>
              <textarea name="Content" rows="10" cols="100" class="form-control" maxlength="999" style="resize:none"></textarea>
            </div>
          </div>

...
<head>
  ...
  <title>Page interest Of Student</title>
...
<body >
  ...
  <div class="container" style="margin-bottom:170px;">
    ...
    <h1 class="mt-4 mb-3">Interest of student
    </h1>
    ...
    <div class="row"  style="margin-left:17%;">
      <div class="col-lg-8 mb-4">
        <form action="interestOfStudentDB.php" method="post">
        ...
        <form action="displaycompany.php" method="post">
